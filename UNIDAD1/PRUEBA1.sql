...
V_OBSERVACION VARCHAR2(30);BEGIN
 ...
 /*
 DBMS_OUTPUT.PUT_LINE('V_ID_VENDEDOR: '||V_ID_VENDEDOR);
 DBMS_OUTPUT.PUT_LINE('V_RUT_VENDEDOR: '||V_RUT_VENDEDOR);
 DBMS_OUTPUT.PUT_LINE('V_MES_PROCESO: '||V_MES_PROCESO);
 DBMS_OUTPUT.PUT_LINE('V_ANNIO_PROCESO: '||V_ANNIO_PROCESO);
 DBMS_OUTPUT.PUT_LINE('V_SUELDO_BASE_VENDEDOR: '||V_SUELDO_BASE_VENDEDOR);
 DBMS_OUTPUT.PUT_LINE('V_BONIFICACION_ANTIGUEDAD: '||V_BONIFICACION_ANTIGUEDAD);
 DBMS_OUTPUT.PUT_LINE('V_ASIG_CARGA_FAM: '||V_ASIG_CARGA_FAM);
 DBMS_OUTPUT.PUT_LINE('V_COMISION_VENTAS: '||V_COMISION_VENTAS);
 DBMS_OUTPUT.PUT_LINE('V_BONO_CATEGORIA: '||V_BONO_CATEGORIA);
 DBMS_OUTPUT.PUT_LINE('V_ID_AFP: '||V_ID_AFP);
 DBMS_OUTPUT.PUT_LINE('V_ID_SALUD: '||V_ID_SALUD);
 DBMS_OUTPUT.PUT_LINE('V_TOTAL_HABERES_FINAL: '||V_TOTAL_HABERES_FINAL);
 */
 
 INSERT INTO HABER_MES_VENDEDOR
 (ID_VENDEDOR, NUMRUT_VENDEDOR, MES_PROCESO,
 ANNO_PROCESO, SUELDO_BASE, ASIG_ANTIGUEDAD,
 ASIG_CARGA_FAM, COMISION_VENTAS, BONO_CATEG,
 TOTAL_HABERES )
 VALUES
 ( V_ID_VENDEDOR,V_RUT_VENDEDOR, V_MES_PROCESO,
 V_ANNIO_PROCESO, V_SUELDO_BASE_VENDEDOR,V_BONIFICACION_ANTIGUEDAD,
 V_ASIG_CARGA_FAM, V_COMISION_VENTAS, V_BONO_CATEGORIA,
 V_TOTAL_HABERES_FINAL );
