...
BEGIN
    ...
    WHILE V_MIN <= V_MAX LOOP
        ...
        (COD_EMP, NUMRUT_EMP, MES_PROCESO,
        ANNO_PROCESO, VALOR_SUELDO_BASE, VALOR_ASIG_ANNOS,
        VALOR_CARGAS_FAM, VALOR_MOVILIZACION, VALOR_COLACION,
        VALOR_COM_VENTAS, VALOR_ASIG_ESCOLARIDAD)
        VALUES
        (V_COD_EMP,V_NUMRUT_EMP, V_MES_PROCESO
        ,V_ANNIO_PROCESO, V_VAL_SUELDO_BASE, V_ASIG_ANNOS,
        V_ASIG_CARGA_FAM, V_VAL_MOV, :B_VAL_COLACION,
        V_VALOR_COMISION_VENTA, V_VAL_ASIG_ESC);
        
        
        INSERT INTO DESCTO_CALC_MES
        (COD_EMP, NUMRUT_EMP, MES_PROCESO,
        ANNO_PROCESO, VALOR_SALUD, VALOR_AFP)
        VALUES
        (V_COD_EMP, V_NUMRUT_EMP, V_MES_PROCESO,
        V_ANNIO_PROCESO, V_VAL_SALUD, V_DESCUENTO_PREVISION_EMPLEADO);
        
        DBMS_OUTPUT.PUT_LINE('V_COD_EMP '||V_COD_EMP);
        DBMS_OUTPUT.PUT_LINE('V_NUMRUT_EMP '||V_NUMRUT_EMP);
        DBMS_OUTPUT.PUT_LINE('V_MES_PROCESO '||V_MES_PROCESO);
        DBMS_OUTPUT.PUT_LINE('V_ANNIO_PROCESO '||V_ANNIO_PROCESO);
        DBMS_OUTPUT.PUT_LINE('V_VAL_SUELDO_BASE '||V_VAL_SUELDO_BASE);
        DBMS_OUTPUT.PUT_LINE('V_ASIG_ANNOS '||V_ASIG_ANNOS);
        DBMS_OUTPUT.PUT_LINE('V_ASIG_CARGA_FAM '||V_ASIG_CARGA_FAM);
        DBMS_OUTPUT.PUT_LINE('V_VAL_MOV '||V_VAL_MOV);
        DBMS_OUTPUT.PUT_LINE('B_VAL_COLACION '||:B_VAL_COLACION);
        DBMS_OUTPUT.PUT_LINE('V_VALOR_COMISION_VENTA '||V_VALOR_COMISION_VENTA);
        DBMS_OUTPUT.PUT_LINE('V_VAL_ASIG_ESC '||V_VAL_ASIG_ESC);
        
        DBMS_OUTPUT.PUT_LINE('V_DESCUENTO_PREVISION_EMPLEADO '||V_DESCUENTO_PREVISION_EMPLEADO);
        DBMS_OUTPUT.PUT_LINE('V_VAL_SALUD '||V_VAL_SALUD);
        DBMS_OUTPUT.PUT_LINE('V_MES_PROCESO||V_ANNIO_PROCESO '||V_MES_PROCESO||V_ANNIO_PROCESO);
